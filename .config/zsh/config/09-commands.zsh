...
alias la="exa -la --icons" #? List all files, including hidden files, formerly "ls -A"
alias ll="exa -l --icons" #? List files in long format
alias lr="exa -lr --icons" #? List files in reverse order
alias ls="exa --icons" #? Use exa by default
alias lt="exa -lt --icons" #? List files sorted by modification time
