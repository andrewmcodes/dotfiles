...
alias la="exa -la --icons --git" #? List all files, including hidden files, formerly "ls -A"
alias ll="exa -l --icons --git" #? List files in long format
alias lr="exa -lr --icons --git" #? List files in reverse order
