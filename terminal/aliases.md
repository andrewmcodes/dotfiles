...
afind='ack -il'
allcontrib='echo '\''@all-contributors please add <username> for <contributions>'\'' | pbcopy'
b=bundle
be='bundle exec'
besk='redis-cli flushall && bundle exec sidekiq -C config/sidekiq.yml'
bwds=./bin/webpack-dev-server
cdbm='bin/rails db:migrate && bin/generate_db_artifacts'
clean_branches='ruby ~/binstubs/git-delete-merged-branches.rb'
ct='cd /Users/andrew.mason/work/gitcoinco/code_fund_ads && bin/tmuxinator'
da='docker attach'
...
deprecations='bin/rails notes --annotations DEPRECATE'
...
gsw='git switch'
gswc='git switch -c'
gtl='gtl(){ git tag --sort=-v:refname -n -l "${1}_" }; noglob gtl'
gts='git tag -s'
gtv='git tag | sort -V'
gun='gem uninstall'
...
rc='bin/rails c'
rd=rmdir
rdbm='bin/rails db:migrate'
rfind='find . -name "_.rb" | xargs grep -n'
rs='bin/rails s'
rt=\_rails_test_command
rta='bin/rails test && bin/rails test:system; notifyMe'
rts='bin/rails test:system; notifyMe'
run-help=man
s=bin/standardize
sgem='sudo gem'
tunnel='ngrok http -subdomain=andrewmcodes 3000'
vsc='code .'
vsca='code --add'
vscd='code --diff'
